...
Фреймворк Django существует довольно давно и обзавелся за это время большим количеством инструментов автоматизации, в том числе для реализации расширения стандартного механизма CRUD.
