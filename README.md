...
Получение данных из БД по запросу пользователя/клиента обязует нас описать отображение этих данных. Так как мы делаем обычное веб-приложение, то отображение необходимо выводить в HTML-страницы. Для этого проведем работу над шаблонами.

Критерий выполнения заданий
Результат задания залейте в github.com и сдайте в виде ссылки на репозиторий.
Задание 1
